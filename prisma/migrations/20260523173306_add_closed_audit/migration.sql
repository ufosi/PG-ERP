...
INSERT INTO "new_ProductionOrder" ("createdAt", "createdById", "customer", "description", "dueDate", "id", "name", "number", "status", "updatedAt", "workerCanComplete") SELECT "createdAt", "createdById", "customer", "description", "dueDate", "id", "name", "number", "status", "updatedAt", "workerCanComplete" FROM "ProductionOrder";
